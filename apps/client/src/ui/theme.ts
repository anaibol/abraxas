  ...
  theme: {
    tokens: {
      ...
      shadows: {
        ...
        buttonBevel: { value: "inset 0 1px 0 rgba(255, 255, 255, 0.1), inset 0 -1px 2px rgba(0, 0, 0, 0.5)" },
        buttonActive: { value: "inset 0 2px 4px rgba(0, 0, 0, 0.7)" },
      },
    },
    keyframes: {
      pulse: {
    ...
    layerStyles: {
      ...
      fantasyButton: {
        value: {
          background: "linear-gradient(to bottom, #2a2533, #1a1628)",
          border: "2px solid",
          borderColor: "#4a3f5f",
          borderTopColor: "#5a4f6f",
          borderBottomColor: "#1a1628",
          borderRadius: "2px",
          boxShadow: "var(--chakra-shadows-buttonBevel)",
          color: "game.goldText",
          fontFamily: "display",
          fontWeight: "bold",
          fontSize: "13px",
          ...
          textTransform: "uppercase",
          _hover: {
            background: "linear-gradient(to bottom, #3a3543, #2a2638)",
            borderColor: "game.goldDark",
          },
          _active: {
            background: "#14111e",
            boxShadow: "var(--chakra-shadows-buttonActive)",
          },
        },
      },
      fantasyBadge: {
        value: {
          background: "game.darkest",
          border: "1px solid",
          borderColor: "game.goldDark",
          borderRadius: "0",
