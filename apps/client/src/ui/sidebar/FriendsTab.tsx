    ...
    <Box p="3">
      <VStack align="stretch" gap="3">
        ...
        <VStack align="stretch" gap="1">
          ...
          {friends.map((friend) => (
            <Flex key={friend.id} layerStyle={T.rowItem} justify="space-between" align="center">
              <HStack gap="2">
                <Box
                  w="6px"
                  h="6px"
                  ...
                  flexShrink={0}
                />
                <Text textStyle={T.bodyMuted} color={friend.online ? T.goldText : T.goldDark}>
                  {friend.name}
                </Text>
              </HStack>
              <HStack gap="1">
        ...
        {pendingFriendRequests.length > 0 && (
          <VStack align="stretch" gap="1">
            ...
            {pendingFriendRequests.map((req) => (
              <Flex key={req.id} layerStyle={T.rowItem} justify="space-between" align="center">
