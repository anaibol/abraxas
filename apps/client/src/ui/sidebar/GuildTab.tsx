...
import { Box, Flex, Text, HStack, VStack, Input } from "@chakra-ui/react";
							...
							<HStack gap="1">
								{amILeader && member.role !== "LEADER" && (
									<>
										{member.role === "MEMBER" ? (
											<Button
												size="xs" variant="ghost" p="0" h="auto" minW="auto" color={T.gold} fontSize="10px"
								...
								{(amILeader || (amIOfficer && member.role === "MEMBER")) && member.sessionId !== myMember?.sessionId && (
									<Button
										size="xs"
										variant="ghost"
										p="0"
